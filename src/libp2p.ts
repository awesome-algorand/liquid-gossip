        ...
        peerDiscovery: [
            bootstrap({
                list: [
                    ...
                    '/dns/p2p.skeller.io/tcp/9002/p2p/12D3KooWPmavaJXhPsi9JsWegWsPucNmJWNuxMmgRHjoHTAYQ4zG',
                    '/dns/p2p.skeller.io/tcp/9003/wss/p2p/12D3KooWPmavaJXhPsi9JsWegWsPucNmJWNuxMmgRHjoHTAYQ4zG'
                ],
            }),
            pubsubPeerDiscovery({
                interval: 2000,
